<h3>For Further Information:<br>Contact Us</h3>

<p>For more information about the Selenium Support Center, or any queries regarding other test automation solutions and methodologies, please leave us a message:</p>
...
<form action="contactUs.php" method="post" id="contactUsForm">
    ...
    <div class="form-inline">
        <label for="message" style="margin-top: 10px; margin-bottom: 10px;">Message:</label>
